...
export default function Sidebar() {
  return (
    <aside className="space-y-6">
      ...
      >
        <div className="w-[100px] h-[100px] mx-auto mb-5 rounded-full bg-gradient-to-br from-[#E3F2FD] to-[#BBDEFB] flex items-center justify-center" style={{ boxShadow: '0 2px 8px var(--accent-border)' }}>
          <span className="text-5xl">👨‍💻</span>
        </div>
        <h3 className="font-semibold text-[22px] mb-2" style={{ color: 'var(--text-primary)' }}>极客新生</h3>
        <p className="text-[13px] mb-5 leading-relaxed" style={{ color: 'var(--text-tertiary)' }}>大一 CS 学生 / Python & C++ 爱好者</p>

        <div className="flex justify-around mb-5">
          <div className="flex-1 py-4">
            <div className="font-bold text-xl" style={{ color: 'var(--text-primary)' }}>25</div>
          ...
          <div className="flex-1 py-4" style={{ borderLeft: '1px solid var(--border-muted)', borderRight: '1px solid var(--border-muted)' }}>
            <div className="font-bold text-xl" style={{ color: 'var(--text-primary)' }}>12</div>
            <div className="text-xs" style={{ color: 'var(--text-faint)' }}>标签</div>
          </div>
          <div className="flex-1 py-4">
            <div className="font-bold text-xl" style={{ color: 'var(--text-primary)' }}>6</div>
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 w-full py-3.5 rounded-lg text-[15px] font-medium transition-all duration-200 hover:scale-105"
