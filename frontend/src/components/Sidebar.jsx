    ...
    <aside className="space-y-6">
      ...
      >
        ...
        <div className="flex justify-around mb-5">
          <Link to="/archive" className="flex-1 py-4 transition-colors duration-200 hover:text-[var(--accent)]">
          ...
          <Link to="/tags" className="flex-1 py-4 transition-colors duration-200 hover:text-[var(--accent)]" style={{ borderLeft: '1px solid var(--border-muted)', borderRight: '1px solid var(--border-muted)' }}>
      ...
      <motion.div
        ...
        style={{ backgroundColor: 'var(--bg-surface)', boxShadow: 'var(--card-shadow)' }}
      >
        <h4 className="font-semibold text-base mb-4" style={{ color: 'var(--text-primary)' }}>快捷导航</h4>
        <div className="space-y-2">
          <Link
            to="/archive"
            className="flex items-center gap-3 py-2 text-sm transition-colors duration-200 hover:text-[var(--accent)]"
            style={{ color: 'var(--text-secondary)' }}
          >
            <span style={{ color: 'var(--accent)' }}>📅</span> 文章归档
          </Link>
          <Link
            to="/tags"
            className="flex items-center gap-3 py-2 text-sm transition-colors duration-200 hover:text-[var(--accent)]"
            style={{ color: 'var(--text-secondary)' }}
          >
            <span style={{ color: 'var(--accent)' }}>🏷️</span> 标签云
          </Link>
        </div>
      </motion.div>
    </aside>
