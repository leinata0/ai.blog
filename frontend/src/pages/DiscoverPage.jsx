...
export default function DiscoverPage() {
  ...
  useEffect(() => {
      ...
      ? fetchSearch(
          {
            ...
            series_slug: seriesFilter || undefined,
            sort: 'relevance',
          },
    ...
    return () => controller.abort()
  }, [contentType, query, seriesFilter])

  const emptyMessage = useMemo(() => {
    if (query || contentType || seriesFilter) {
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--bg-canvas)' }}>
      <SeoMeta
        title="发现 - AI 资讯观察"
        description="按内容类型、系列和关键词发现值得持续追踪的 AI 文章、主题与变化脉络。"
        path="/discover"
      />
      <Navbar />
