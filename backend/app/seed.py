...
作为一名大一计算机专业的学生，我的课余时间几乎都泡在终端和编辑器里。用 Python 写 Selenium + Pandas 自动化脚本抓数据、啃 C/C++ 的指针与内存管理、研究 OpenClaw 开源项目的私有化部署——这些"硬核折腾"构成了我大学生活的主旋律。与此同时，我还在业余时间辅导一位七年级学生的数学，常常需要把抽象的代数概念翻译成初中生能听懂的语言，这种"降维表达"的训练反过来也让我写技术文章时更注重可读性。
...
这个博客会持续更新，记录我在 Python、C/C++、开源项目和数学辅导中的所有折腾。如果你也是一个喜欢动手的极客新生，欢迎一起交流。
